...
import com.backend.mvc.dao.FriendDao;
...
private FriendDao friendDao;
    ...
    //----------- RequestMapping for getAllFriends method to get list of friends (using HTTP GET method) ----------//
    ...
    //------ RequestMapping for friendRequest to get list of friends whose request accepted (using HTTP POST method) ------//
    ...
    //------ RequestMapping for pendingRequest to get friends list whose request is pending (using HTTP GET method) ------//
     ...
     //------- RequestMapping for updateFriendRequest to update status (Pending/Accept/Deny) -------//
