...
//-----------RequestMapping for login credential with authentication of user  (using HTTP POST method) --------------//
...
public ResponseEntity<?> login(@RequestBody User user,HttpSession session ){
	...
	if(validUser==null){
		...
		//----------  code for uploading the file (as profile picture)  ------------//
...
//----- RequestMapping for Registering new user into the database with resisterUser method  (using HTTP POST method) -------//
...
//-----------RequestMapping for logout  with updateUser method (using HTTP PUT method) --------------//
...
//------- RequestMapping for Get All Users to get All users list from database (using HTTP GET method) --------//
